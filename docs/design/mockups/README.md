...
| [`11-worlds-scene.html`](11-worlds-scene.html) | **Worlds** 🪐 experiment | The parked "worlds in orbit" scene (Sun + planets on a tilted revolving plane) — the first experiment behind Voyager's Golden Record (P27-61 / branch `experiment/worlds-solar-system`) | Peach + baby-blue |
